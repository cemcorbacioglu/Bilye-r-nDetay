...
int main()
{
    ...
    do
    {
        ...
        do
        {
            printf("\nkutuya agirligi girilecek toplam Bilye sayisini girin.\n");
        ...
        if (agirlik2 == agirlik1)
        {
            ...
            printf("\n3.Bilyeanin agirligini giriniz.\n");
            scanf("%d",&agirlik3);
        ...
        if (basa_don!=1)
        {
            ...
            if (farkli_agirlik_say>0)
            {
                ...
                {
                    printf("kutuda 1 adet hafif Bilye var.\n");
                    ...
                    printf("fark yuzdesi: %2.f",fark_yuzdesi);

                }
                else
                {
                    printf("kutuda 1 adet agir Bilye var.\n");
            ...
            {
                printf("kutuda her agirlik ayni.\n");
        ...
        do
        {
            printf("\ntekrar girmek istermisin?(e/E/h/H)\n");
            scanf("%c",&devam);
            fflush(stdin);
            devam=getchar();
        }
    ...
    printf("uretim hatasi olan ve iade edilen kutu sayisi:%d\n",iade_kutu);
    ...
    if (agir_bilyeli_kutu_say>0)
    {
        printf("agir bilyelarin agirliklarinin farklari ortalamasi:%.2f\n",agir_bilye_fark_toplam/agir_bilyeli_kutu_say);
        printf("agir bilyelarin agirlik farki yuzdeleri ortalamasi:%.2f%%\n\n",agir_bilyeli_fark_yuzdesi_toplami/agir_bilyeli_kutu_say);
    }
